...
def get_liftover_variant(input_variant: SupportedVrsVariation) -> SupportedVrsVariation:
    ...
    """
    try:
        refget_accession = input_variant.location.sequenceReference.refgetAccession  # pyright: ignore[reportAttributeAccessIssue, reportOptionalMemberAccess]
        start_position = input_variant.location.start  # pyright: ignore[reportAttributeAccessIssue]
        end_position = input_variant.location.end  # pyright: ignore[reportAttributeAccessIssue]
