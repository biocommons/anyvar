...
```pycon
>>> import requests
>>> response = requests.put("http://localhost:8000/variations", json={"definition": "NC_000010.11:g.87894077C>T"})
>>> response.json()
...
>>> response = requests.get("http://localhost:8000/variations/ga4gh:VA.K7akyz9PHB0wg8wBNVlWAAdvMbJUJJfU")
>>> response.json()
